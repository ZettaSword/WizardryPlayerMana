...
public class CommandCheckMana extends CommandBase {
    ...
    public String getUsage(@Nonnull ICommandSender p_71518_1_){
        ...
        return "commands." + PlayerMana.MODID + ":checkMana.usage";
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args) throws CommandException {
        ...
        if(args.length > 1) {
            throw new WrongUsageException("commands." + PlayerMana.MODID + ":checkMana.usage", "checkMana");
        }
        ...
        if(manaOf != null){
            ...
            if(soul != null){
                sender.sendMessage(new TextComponentTranslation("commands." + PlayerMana.MODID + ":checkMana.use",

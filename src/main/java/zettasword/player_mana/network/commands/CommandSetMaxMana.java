...
public class CommandSetMaxMana extends CommandBase {
    ...
    public String getUsage(@Nonnull ICommandSender p_71518_1_){
        ...
        return "commands." + PlayerMana.MODID + ":setMaxMana.usage";
    ...
    public void execute(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args) throws CommandException {
        if(args.length != 2) {
            throw new WrongUsageException("commands." + PlayerMana.MODID + ":setMaxMana.usage", "setMaxMana");
        }
